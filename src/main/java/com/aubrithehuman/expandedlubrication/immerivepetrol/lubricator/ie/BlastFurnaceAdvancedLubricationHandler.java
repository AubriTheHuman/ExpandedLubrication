...
public class BlastFurnaceAdvancedLubricationHandler implements ILubricationHandler<BlastFurnaceAdvancedTileEntity>{
//	private static final float factor = AMIConfig.tier_1_factor.get();
	...
	public TileEntity isPlacedCorrectly(World world, AutoLubricatorTileEntity lubricator, Direction facing){
		...
		if(te instanceof BlastFurnaceAdvancedTileEntity){
			BlastFurnaceTileEntity master = ((BlastFurnaceAdvancedTileEntity) te).master();
	...
	@Override
	public void lubricate(World arg0, int arg1, BlastFurnaceAdvancedTileEntity arg2) { }

	@Override
	public void lubricate(World arg0, Fluid arg1, int arg2, BlastFurnaceAdvancedTileEntity arg3) { }
	
	@Override
	public void lubricateClient(ClientWorld arg0, Fluid arg1, int arg2, BlastFurnaceAdvancedTileEntity arg3) {
		
	}

	@Override
	public void lubricateServer(ServerWorld world, Fluid lubricant, int ticks, BlastFurnaceAdvancedTileEntity mbte) {
		tierProcess(lubricant, mbte, ticks, world);		
	}
	
	public void tierProcess(Fluid fluid, BlastFurnaceAdvancedTileEntity mbte, int ticks, World world) {
		double times = 0.0D;
...
//		System.out.println("doing " + times);
	...
	public boolean process(BlastFurnaceAdvancedTileEntity mbte, int ticks, World world) {
		mbte.tick();
		return true;
	}
	
	@Override
	public boolean isMachineEnabled(World world, BlastFurnaceAdvancedTileEntity mbte){
		return mbte.getIsActive();
	}
				
	@Override
	public void spawnLubricantParticles(ClientWorld world, AutoLubricatorTileEntity lubricator, Direction facing, BlastFurnaceAdvancedTileEntity mbte){
	...
	@Override
	public Tuple<BlockPos, Direction> getGhostBlockPosition(World world, BlastFurnaceAdvancedTileEntity mbte){
//		System.out.println("checkghost");
		if(!mbte.isDummy()){
			BlockPos pos = mbte.getBlockPos().relative(mbte.getFacing(), -2).above();
	...
	@Override
	@OnlyIn(Dist.CLIENT)
	public void renderPipes(AutoLubricatorTileEntity lubricator, BlastFurnaceAdvancedTileEntity mbte, MatrixStack matrix, IRenderTypeBuffer buffer, int combinedLight, int combinedOverlay){
