...
public class CrudeBlastFurnaceLubricationHandler implements ILubricationHandler<BlastFurnaceTileEntity>{
//	private static final float factor = AMIConfig.tier_1_factor.get();
	...
	@Override
	public void lubricate(World arg0, int arg1, BlastFurnaceTileEntity arg2) { }

	@Override
	public void lubricate(World arg0, Fluid arg1, int arg2, BlastFurnaceTileEntity arg3) { }
	
	@Override
	public void lubricateClient(ClientWorld arg0, Fluid arg1, int arg2, BlastFurnaceTileEntity arg3) {
		
	}

	@Override
	public void lubricateServer(ServerWorld world, Fluid lubricant, int ticks, BlastFurnaceTileEntity mbte) {
		tierProcess(lubricant, mbte, ticks, world);		
	}
	
	public void tierProcess(Fluid fluid, BlastFurnaceTileEntity mbte, int ticks, World world) {
		double times = 0.0D;
...
//		System.out.println("doing " + times);
	...
	public boolean process(BlastFurnaceTileEntity mbte, int ticks, World world) {
		mbte.tick();
		return true;
	}
	
	@Override
	public boolean isMachineEnabled(World world, BlastFurnaceTileEntity mbte){
		return mbte.getIsActive();
	}
				
	@Override
	public void spawnLubricantParticles(ClientWorld world, AutoLubricatorTileEntity lubricator, Direction facing, BlastFurnaceTileEntity mbte){
	...
	@Override
	public Tuple<BlockPos, Direction> getGhostBlockPosition(World world, BlastFurnaceTileEntity mbte){
//		System.out.println("checkghost");
	...
	@Override
	@OnlyIn(Dist.CLIENT)
	public void renderPipes(AutoLubricatorTileEntity lubricator, BlastFurnaceTileEntity mbte, MatrixStack matrix, IRenderTypeBuffer buffer, int combinedLight, int combinedOverlay){
