...
public class ElectrolyzerLubricationHandler implements ILubricationHandler<IndustrialElectrolyzerTileEntity> {
//	private static final float factor = AMIConfig.tier_1_factor.get();
	...
	public TileEntity isPlacedCorrectly(World world, AutoLubricatorTileEntity lubricator, Direction facing){
		...
		if(te instanceof IndustrialElectrolyzerTileEntity){
			IndustrialElectrolyzerTileEntity master = ((IndustrialElectrolyzerTileEntity) te).master();
	...
	@Override
	public void lubricate(World arg0, int arg1, IndustrialElectrolyzerTileEntity arg2) { }

	@Override
	public void lubricate(World arg0, Fluid arg1, int arg2, IndustrialElectrolyzerTileEntity arg3) { }
	
	@Override
	public void lubricateClient(ClientWorld arg0, Fluid arg1, int arg2, IndustrialElectrolyzerTileEntity arg3) {
		
	}

	@Override
	public void lubricateServer(ServerWorld world, Fluid lubricant, int ticks, IndustrialElectrolyzerTileEntity mbte) {
		tierProcess(lubricant, mbte, ticks, world);		
	}
	
	public void tierProcess(Fluid fluid, IndustrialElectrolyzerTileEntity mbte, int ticks, World world) {
		double times = 0.0D;
...
//		
	...
	public boolean process(IndustrialElectrolyzerTileEntity mbte, int ticks, World world) {
		mbte.tick();
		return true;
	}
	
	@Override
	public boolean isMachineEnabled(World world, IndustrialElectrolyzerTileEntity mbte){
		return mbte.process > 0;
	}
				
	@Override
	public void spawnLubricantParticles(ClientWorld world, AutoLubricatorTileEntity lubricator, Direction facing, IndustrialElectrolyzerTileEntity mbte){
...
//		System.out.println("checkghost");
	...
	@Override
	@OnlyIn(Dist.CLIENT)
	public void renderPipes(AutoLubricatorTileEntity lubricator, IndustrialElectrolyzerTileEntity mbte, MatrixStack matrix, IRenderTypeBuffer buffer, int combinedLight, int combinedOverlay){
