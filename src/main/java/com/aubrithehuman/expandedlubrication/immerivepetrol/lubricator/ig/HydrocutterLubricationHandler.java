...
public class HydrocutterLubricationHandler extends TieredLubricationHandler<AutoLubricatorTileEntity, HydroJetCutterTileEntity, HydrojetRecipe> {
//	private static final float factor = AMIConfig.tier_1_factor.get();
	private static Vector3i size = new Vector3i(3, 2, 2);
	...
	public TileEntity isPlacedCorrectly(World world, AutoLubricatorTileEntity lubricator, Direction facing){
		...
		if(te instanceof HydroJetCutterTileEntity){
			HydroJetCutterTileEntity master = ((HydroJetCutterTileEntity) te).master();
	...
	@Override
	public boolean process(Iterator<MultiblockProcess<HydrojetRecipe>> processIterator, MultiblockProcess<HydrojetRecipe> process, HydroJetCutterTileEntity mbte, int ticks, World world) {
		mbte.tick();
...
//		}
	...
	@Override
	public void spawnLubricantParticles(ClientWorld world, AutoLubricatorTileEntity lubricator, Direction facing, HydroJetCutterTileEntity mbte){
	...
	@Override
	public Tuple<BlockPos, Direction> getGhostBlockPosition(World world, HydroJetCutterTileEntity mbte){
//		System.out.println("checkghost");
	...
	@Override
	@OnlyIn(Dist.CLIENT)
	public void renderPipes(AutoLubricatorTileEntity lubricator, HydroJetCutterTileEntity mbte, MatrixStack matrix, IRenderTypeBuffer buffer, int combinedLight, int combinedOverlay){
