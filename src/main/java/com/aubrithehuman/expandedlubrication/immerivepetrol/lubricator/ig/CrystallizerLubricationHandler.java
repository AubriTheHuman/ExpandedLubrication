...
public class CrystallizerLubricationHandler extends TieredLubricationHandler<AutoLubricatorTileEntity, CrystallizerTileEntity, CrystalRecipe>{
//	private static final float factor = AMIConfig.tier_1_factor.get();
	...
	@Override
	public boolean process(Iterator<MultiblockProcess<CrystalRecipe>> processIterator, MultiblockProcess<CrystalRecipe> process, CrystallizerTileEntity mbte, int ticks, World world) {
		mbte.tick();
...
//		}
	...
	@Override
	public void spawnLubricantParticles(ClientWorld world, AutoLubricatorTileEntity lubricator, Direction facing, CrystallizerTileEntity mbte){
...
//		System.out.println("checkghost");
	...
	@Override
	@OnlyIn(Dist.CLIENT)
	public void renderPipes(AutoLubricatorTileEntity lubricator, CrystallizerTileEntity mbte, MatrixStack matrix, IRenderTypeBuffer buffer, int combinedLight, int combinedOverlay){
