...
public class CokeOvenLubricationHandler implements ILubricationHandler<CokeOvenTileEntity>{
//	private static final float factor = AMIConfig.tier_1_factor.get();
	...
	public TileEntity isPlacedCorrectly(World world, AutoLubricatorTileEntity lubricator, Direction facing){
		...
		if(te instanceof CokeOvenTileEntity){
			CokeOvenTileEntity master = ((CokeOvenTileEntity) te).master();
	...
	@Override
	public void lubricate(World arg0, int arg1, CokeOvenTileEntity arg2) { }

	@Override
	public void lubricate(World arg0, Fluid arg1, int arg2, CokeOvenTileEntity arg3) { }
	
	@Override
	public void lubricateClient(ClientWorld arg0, Fluid arg1, int arg2, CokeOvenTileEntity arg3) {
		
	}

	@Override
	public void lubricateServer(ServerWorld world, Fluid lubricant, int ticks, CokeOvenTileEntity mbte) {
		tierProcess(lubricant, mbte, ticks, world);		
	}
	
	public void tierProcess(Fluid fluid, CokeOvenTileEntity mbte, int ticks, World world) {
		double times = 0.0D;
...
//		System.out.println("doing " + times);
	...
	public boolean process(CokeOvenTileEntity mbte, int ticks, World world) {
		mbte.tick();
		return true;
	}
	
	@Override
	public boolean isMachineEnabled(World world, CokeOvenTileEntity mbte){
		return mbte.getIsActive();
	}
				
	@Override
	public void spawnLubricantParticles(ClientWorld world, AutoLubricatorTileEntity lubricator, Direction facing, CokeOvenTileEntity mbte){
	...
	@Override
	public Tuple<BlockPos, Direction> getGhostBlockPosition(World world, CokeOvenTileEntity mbte){
//		System.out.println("checkghost");
	...
	@Override
	@OnlyIn(Dist.CLIENT)
	public void renderPipes(AutoLubricatorTileEntity lubricator, CokeOvenTileEntity mbte, MatrixStack matrix, IRenderTypeBuffer buffer, int combinedLight, int combinedOverlay){
