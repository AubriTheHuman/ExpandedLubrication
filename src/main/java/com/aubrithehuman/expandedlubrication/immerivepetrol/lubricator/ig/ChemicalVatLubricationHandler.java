...
//	private static final float factor = AMIConfig.tier_1_factor.get();
	...
	@Override
	public boolean process(Iterator<MultiblockProcess<VatRecipe>> processIterator, MultiblockProcess<VatRecipe> process, ChemicalVatTileEntity mbte, int ticks, World world) {
		mbte.tick();
