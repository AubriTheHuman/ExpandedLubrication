...
public class SqueezerLubricationHandler extends TieredLubricationHandler<AutoLubricatorTileEntity, SqueezerTileEntity, SqueezerRecipe>{
//	private static final float factor = AMIConfig.tier_1_factor.get();
	...
	public TileEntity isPlacedCorrectly(World world, AutoLubricatorTileEntity lubricator, Direction facing){
		...
		if(te instanceof SqueezerTileEntity){
			SqueezerTileEntity master = ((SqueezerTileEntity) te).master();
...
//		}
	...
	@Override
	public AutoLubricatorTileEntity getLubricatorTE(World world, SqueezerTileEntity mbte) {
	...
	@Override
	public void lubricateWithFluid(World world, int ticks, Fluid fluid, SqueezerTileEntity mbte) {
...
//			mbte.animation_piston %= 360f;
	...
	@Override
	public void spawnLubricantParticles(World world, AutoLubricatorTileEntity lubricator, Direction facing, SqueezerTileEntity mbte){
	...
	@Override
	public Tuple<BlockPos, Direction> getGhostBlockPosition(World world, SqueezerTileEntity mbte){
