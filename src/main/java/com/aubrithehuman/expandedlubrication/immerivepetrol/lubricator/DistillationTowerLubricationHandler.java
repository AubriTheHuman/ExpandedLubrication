...
//			mbte.animation_agitator %= 360f;
	...
	@Override
	public boolean process(Iterator<MultiblockProcess<DistillationRecipe>> processIterator, MultiblockProcess<DistillationRecipe> process, DistillationTowerTileEntity mbte) {
		mbte.tick();
